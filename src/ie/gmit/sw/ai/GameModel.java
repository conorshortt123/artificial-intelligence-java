...
public class GameModel {
	...
	private void addGameCharacters() {
		...
		addGameCharacter(tasks, '\u0032', '0', MAX_CHARACTERS / 10, new FuzzyMinotaur(100, 100, 0, MinotaurState.PATROL)); //2 is a Red Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0033', '0', MAX_CHARACTERS / 10, new NeuralMinotaur(100, 100, 0, MinotaurState.PATROL)); //3 is a Pink Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0034', '0', MAX_CHARACTERS / 10, new FuzzyMinotaur(100, 100, 0, MinotaurState.PATROL)); //4 is a Blue Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0035', '0', MAX_CHARACTERS / 10, new NeuralMinotaur(100, 100, 0, MinotaurState.PATROL)); //5 is a Red Green Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0036', '0', MAX_CHARACTERS / 10, new FuzzyMinotaur(100, 100, 0, MinotaurState.PATROL)); //6 is a Orange Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0032', '0', MAX_CHARACTERS / 10, new FuzzyMinotaur(100, 100, 0, MinotaurState.PATROL)); //2 is a Red Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0033', '0', MAX_CHARACTERS / 10, new NeuralMinotaur(100, 100, 0, MinotaurState.PATROL)); //3 is a Pink Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0034', '0', MAX_CHARACTERS / 10, new FuzzyMinotaur(100, 100, 0, MinotaurState.PATROL)); //4 is a Blue Enemy, 0 is a hedge
		addGameCharacter(tasks, '\u0035', '0', MAX_CHARACTERS / 10, new NeuralMinotaur(100, 100, 0, MinotaurState.PATROL)); //5 is a Red Green Enemy, 0 is a hedge
	...
	private void addGameCharacter(Collection<Task<Void>> tasks, char enemyID, char replace, int number, Minotaur minotaur){
		...
		while (counter < number){
			...
			if (model[row][col] == replace){
				...
				tasks.add(new CharacterTask(this, enemyID, row, col, minotaur));
				counter++;
			}
		}
	}
